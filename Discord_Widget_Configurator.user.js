          ...
          <div id="${PREFIX}-container">
            ...
            <div id="${PREFIX}-content" class="${PREFIX}-scroll">
              ...
              <div id="${PREFIX}-fallback">
                <p style="margin: 0 0 8px 0; font-weight: 700; color: ##00b515;">Identity Integration Sync command/p>
                ...
                <button class="${PREFIX}-btn" id="${PREFIX}-copy" style="margin-top: 12px; background: ##00b515;">Copy Payload Command</button>
              </div>
            </div>
          </div>
        `;
